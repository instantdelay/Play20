...
object PlayBuild extends Build {
    ...
    ).settings(com.typesafe.sbtscalariform.ScalariformPlugin.defaultScalariformSettings: _*).dependsOn(SbtLinkProject, RoutesCompilerProject, PlayUtilsProject, TemplatesProject, AnormProject)
